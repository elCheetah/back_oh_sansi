...
export function validarFila(
    ...
    if (!codA && !nomA) {
        errores.push({ fila: filaNum, codigo: 'E-AREA-001', columna: 'AREA_COD/AREA_NOM', mensaje: MENSAJES.errores['E-AREA-001']() });
    }
    ...
    if (!area) {
        errores.push({ fila: filaNum, codigo: 'E-AREA-002', columna: 'AREA_COD/AREA_NOM', valor: `${codA}|${nomA}`, mensaje: MENSAJES.errores['E-AREA-002'](codA, nomA) });
    } else if (codA && nomA) {
        ...
        if (!byCod || !byNom || byCod.id !== byNom.id) {
            errores.push({ fila: filaNum, codigo: 'E-AREA-003', columna: 'AREA_COD/AREA_NOM', mensaje: MENSAJES.errores['E-AREA-003']() });
        }
    }
    ...
    if (!codN && !nomN) {
        errores.push({ fila: filaNum, codigo: 'E-NIV-001', columna: 'NIVEL_COD/NIVEL_NOM', mensaje: MENSAJES.errores['E-NIV-001']() });
    }
    ...
    if (!nivel) {
        errores.push({ fila: filaNum, codigo: 'E-NIV-002', columna: 'NIVEL_COD/NIVEL_NOM', valor: `${codN}|${nomN}`, mensaje: MENSAJES.errores['E-NIV-002'](codN, nomN) });
    } else if (codN && nomN) {
        const byCod = cat.nivelesPorCodigo.get(mayus(codN));
        const byNom = cat.nivelesPorNombre.get(mayus(nomN));
        if (!byCod || !byNom || byCod.id !== byNom.id) {
            errores.push({ fila: filaNum, codigo: 'E-NIV-003', columna: 'NIVEL_COD/NIVEL_NOM', mensaje: MENSAJES.errores['E-NIV-003']() });
        }
    }
    ...
    if (!CATALOGOS.OLI_TDOC.includes(filaAny.OLI_TDOC as any)) {
        errores.push({ fila: filaNum, codigo: 'E-DOC-001', columna: 'OLI_TDOC', valor: filaAny.OLI_TDOC, mensaje: MENSAJES.errores['E-DOC-001'](filaAny.OLI_TDOC) });
    }
    if (!filaAny.OLI_NRODOC) {
        errores.push({ fila: filaNum, codigo: 'E-DOC-002', columna: 'OLI_NRODOC', mensaje: MENSAJES.errores['E-DOC-002']() });
    }
    if (!filaAny.OLI_NOMBRE || !filaAny.OLI_AP_PAT) {
        errores.push({ fila: filaNum, codigo: 'E-OLI-001', columna: 'OLI_NOMBRE/OLI_AP_PAT', mensaje: MENSAJES.errores['E-OLI-001']() });
    }
    if (!filaAny.OLI_UNID_EDU) {
        errores.push({ fila: filaNum, codigo: 'E-UE-001', columna: 'OLI_UNID_EDU', mensaje: MENSAJES.errores['E-UE-001']() });
    }
    if (filaAny.OLI_DEPTO && !CATALOGOS.DEPARTAMENTOS.includes(filaAny.OLI_DEPTO as any)) {
        errores.push({ fila: filaNum, codigo: 'E-DEP-001', columna: 'OLI_DEPTO', valor: filaAny.OLI_DEPTO, mensaje: MENSAJES.errores['E-DEP-001'](filaAny.OLI_DEPTO) });
    }
    if (filaAny.OLI_GRADO && !/^(1RO|2DO|3RO|4TO|5TO|6TO) SEC$/.test(filaAny.OLI_GRADO)) {
        warnings.push({ fila: filaNum, codigo: 'W-GRADO-001', columna: 'OLI_GRADO', valor: filaAny.OLI_GRADO, mensaje: MENSAJES.warnings['W-GRADO-001']() });
    }
    if (filaAny.OLI_F_NAC && !validarFechaYYYYMMDD(filaAny.OLI_F_NAC)) {
        errores.push({ fila: filaNum, codigo: 'E-FNAC-001', columna: 'OLI_F_NAC', valor: filaAny.OLI_F_NAC, mensaje: MENSAJES.errores['E-FNAC-001'](filaAny.OLI_F_NAC) });
    }
    if (filaAny.OLI_SEXO && !CATALOGOS.OLI_SEXO.includes(filaAny.OLI_SEXO as any)) {
        errores.push({ fila: filaNum, codigo: 'E-SEXO-001', columna: 'OLI_SEXO', valor: filaAny.OLI_SEXO, mensaje: MENSAJES.errores['E-SEXO-001'](filaAny.OLI_SEXO) });
    }
    if (!emailValido(filaAny.OLI_CORREO)) {
        errores.push({ fila: filaNum, codigo: 'E-OLI-EMAIL-001', columna: 'OLI_CORREO', valor: filaAny.OLI_CORREO, mensaje: MENSAJES.errores['E-OLI-EMAIL-001'](filaAny.OLI_CORREO) });
    }

    // C.5 Tutor
    if (!CATALOGOS.OLI_TDOC.includes(filaAny.TUTOR_TDOC as any)) {
        errores.push({ fila: filaNum, codigo: 'E-DOC-001', columna: 'TUTOR_TDOC', valor: filaAny.TUTOR_TDOC, mensaje: MENSAJES.errores['E-DOC-001'](filaAny.TUTOR_TDOC) });
    }
    if (!filaAny.TUTOR_NRODOC) {
        errores.push({ fila: filaNum, codigo: 'E-DOC-002', columna: 'TUTOR_NRODOC', mensaje: MENSAJES.errores['E-DOC-002']() });
    }
    if (!filaAny.TUTOR_NOMBRE || !filaAny.TUTOR_AP_PAT) {
        errores.push({ fila: filaNum, codigo: 'E-OLI-001', columna: 'TUTOR_NOMBRE/TUTOR_AP_PAT', mensaje: MENSAJES.errores['E-OLI-001']() });
    }
    if (!filaAny.TUTOR_TEL || filaAny.TUTOR_TEL.length < 7) {
        errores.push({ fila: filaNum, codigo: 'E-TUT-TEL-001', columna: 'TUTOR_TEL', valor: filaAny.TUTOR_TEL, mensaje: MENSAJES.errores['E-TUT-TEL-001'](filaAny.TUTOR_TEL) });
    }
    if (!emailValido(filaAny.TUTOR_CORREO)) {
        errores.push({ fila: filaNum, codigo: 'E-TUT-EMAIL-001', columna: 'TUTOR_CORREO', valor: filaAny.TUTOR_CORREO, mensaje: MENSAJES.errores['E-TUT-EMAIL-001'](filaAny.TUTOR_CORREO) });
    }
    ...
    if (tipo === 'INDIVIDUAL') {
        if (filaAny.EQUIPO_NOMBRE || filaAny.ROL_EQUIPO) {
            errores.push({ fila: filaNum, codigo: 'E-CROSS-IND-001', mensaje: MENSAJES.errores['E-CROSS-IND-001']() });
            return { errores, warnings, fila: filaAny as FilaImportacion };
        }
        ...
        if (!filaAny.EQUIPO_NOMBRE || !filaAny.ROL_EQUIPO) {
            errores.push({ fila: filaNum, codigo: 'E-CROSS-EQP-001', mensaje: MENSAJES.errores['E-CROSS-EQP-001']() });
            return { errores, warnings, fila: filaAny as FilaImportacion };
        }
        if (!(['LIDER', 'PARTICIPANTE'] as const).includes(filaAny.ROL_EQUIPO as any)) {
            errores.push({ fila: filaNum, codigo: 'E-ROL-001', columna: 'ROL_EQUIPO', valor: filaAny.ROL_EQUIPO, mensaje: MENSAJES.errores['E-ROL-001'](filaAny.ROL_EQUIPO) });
            return { errores, warnings, fila: filaAny as FilaImportacion };
        }
